...
import { $fetch as $fetch$1 } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks, createDebugger } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, createDefu } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol, parsePath, parseQuery, withoutTrailingSlash } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/ufo/dist/index.mjs";
import { klona } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/destr/dist/index.mjs";
import { isEqual } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/ohash/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/mnt/Dados/Dev/VSCODE/mea-ecclesia-catholic/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-D8ZO8Lcr.js")
  },
  {
    name: "missa",
    path: "/missa",
    component: () => import("./_nuxt/missa-MvkPXgr_.js")
  },
  {
    name: "livros",
    path: "/livros",
    component: () => import("./_nuxt/livros-CrCQ3W69.js")
  },
  {
    name: "santos",
    path: "/santos",
    component: () => import("./_nuxt/santos-BsZXiYTy.js")
  }
];
  ...
  pt: [
    {
      ...
      load: () => import(
        "./_nuxt/pt-D1e43TZe.js"
        /* webpackChunkName: "locale_pt_46json_d769759e" */
      ),
      cache: true
    }
  ],
  la: [
    {
      ...
      load: () => import(
        "./_nuxt/la-DxXu0Mri.js"
        /* webpackChunkName: "locale_la_46json_50dfc134" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        "./_nuxt/en-B_ivcJEN.js"
        /* webpackChunkName: "locale_en_46json_c5e9ec7b" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { pt: "ec4a7c5f", la: "ec4a7c5f", en: "ec4a7c5f" };
...
var define_I18N_LOCALE_HASHES_default = { pt: "ec4a7c5f", la: "ec4a7c5f", en: "ec4a7c5f" };
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-GgTAAr8n.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-95H6uFFq.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DqQpjCmu.js"));
