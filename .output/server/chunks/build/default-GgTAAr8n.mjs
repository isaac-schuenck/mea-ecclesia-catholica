globalThis.__timing__.logStart('Load chunks/build/default-GgTAAr8n');import { b as buildAssetsURL } from '../nitro/nitro.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-CTNVGgpg.mjs';
...
const _imports_0 = "" + buildAssetsURL("logosfundo.IyWl3dXT.png");
const _sfc_main = {
  __name: "default",
  ...
  setup(__props) {
    ...
    const currentLangDisplay = computed(() => {
      if (locale.value === "pt") return { code: "PT", flag: "\u{1F1E7}\u{1F1F7}" };
      if (locale.value === "la") return { code: "LA", flag: "\u{1F1FB}\u{1F1E6}" };
      if (locale.value === "en") return { code: "EN", flag: "\u{1F1EC}\u{1F1E7}" };
      return { code: "EN", flag: "\u{1F1EC}\u{1F1E7}" };
    });
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/default-GgTAAr8n');
//# sourceMappingURL=default-GgTAAr8n.mjs.map
