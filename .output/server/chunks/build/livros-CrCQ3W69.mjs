globalThis.__timing__.logStart('Load chunks/build/livros-CrCQ3W69');import { ref, mergeProps, unref, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.books, (book) => {
        ...
        _push(`</div></button><div class="bg-gray-50 px-5 pt-4 pb-5 md:px-6 md:pt-4 md:pb-6 border-t border-gray-200/70" style="${ssrRenderStyle(isOpen(book.tituloKey) ? null : { display: "none" })}"><div class="${ssrRenderClass([((_a = book.meta) == null ? void 0 : _a.length) ? "lg:grid-cols-[minmax(0,1fr)_14rem]" : "", "grid gap-6 md:pl-12"])}"><div class="grid grid-cols-2 gap-4 sm:flex sm:flex-wrap sm:gap-5"><!--[-->`);
        ...
        _push(`<!--]--></div>`);
        if ((_b = book.meta) == null ? void 0 : _b.length) {
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/livros-CrCQ3W69');
//# sourceMappingURL=livros-CrCQ3W69.mjs.map
