...
import { q as parseURL, e as encodePath, r as decodePath, s as hasProtocol, t as isScriptProtocol, v as joinURL, w as withQuery, x as sanitizeStatusCode, y as getContext, $ as $fetch$1, z as baseURL, A as defu, B as createHooks, j as createError$1, C as executeAsync, D as createDebugger, E as getRequestURL, F as getRequestHeader, G as getCookie, H as klona, I as destr, J as isEqual, K as createDefu, L as parsePath, M as parseQuery, N as setCookie, O as deleteCookie, P as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-D8ZO8Lcr.mjs')
  },
  {
    name: "missa",
    path: "/missa",
    component: () => import('./missa-MvkPXgr_.mjs')
  },
  {
    name: "livros",
    path: "/livros",
    component: () => import('./livros-CrCQ3W69.mjs')
  },
  {
    name: "santos",
    path: "/santos",
    component: () => import('./santos-BsZXiYTy.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-GgTAAr8n.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-95H6uFFq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DqQpjCmu.mjs'));
...
export { _export_sfc as _, useI18n as a, useRouter as b, useNuxtApp as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, useHead as u };;globalThis.__timing__.logEnd('Load chunks/build/server');
